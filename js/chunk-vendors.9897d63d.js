 ...
 * limitations under the License.
 */
class A{constructor(t){this.container=t}getPlatformInfoString(){const t=this.container.getProviders();return t.map((t=>{if(O(t)){const e=t.getImmediate();return`${e.library}/${e.version}`}return null})).filter((t=>t)).join(" ")}}function O(t){const e=t.getComponent();return"VERSION"===(null===e||void 0===e?void 0:e.type)}const L="@firebase/app",N="0.9.0",D=new r.Yd("@firebase/app"),R="@firebase/app-compat",$="@firebase/analytics-compat",P="@firebase/analytics",M="@firebase/app-check-compat",V="@firebase/app-check",B="@firebase/auth",F="@firebase/auth-compat",j="@firebase/database",U="@firebase/database-compat",z="@firebase/functions",H="@firebase/functions-compat",q="@firebase/installations",Z="@firebase/installations-compat",W="@firebase/messaging",K="@firebase/messaging-compat",G="@firebase/performance",X="@firebase/performance-compat",Q="@firebase/remote-config",Y="@firebase/remote-config-compat",J="@firebase/storage",tt="@firebase/storage-compat",et="@firebase/firestore",nt="@firebase/firestore-compat",it="firebase",rt="9.15.0",st="[DEFAULT]",ot={[L]:"fire-core",[R]:"fire-core-compat",[P]:"fire-analytics",[$]:"fire-analytics-compat",[V]:"fire-app-check",[M]:"fire-app-check-compat",[B]:"fire-auth",[F]:"fire-auth-compat",[j]:"fire-rtdb",[U]:"fire-rtdb-compat",[z]:"fire-fn",[H]:"fire-fn-compat",[q]:"fire-iid",[Z]:"fire-iid-compat",[W]:"fire-fcm",[K]:"fire-fcm-compat",[G]:"fire-perf",[X]:"fire-perf-compat",[Q]:"fire-rc",[Y]:"fire-rc-compat",[J]:"fire-gcs",[tt]:"fire-gcs-compat",[et]:"fire-fst",[nt]:"fire-fst-compat","fire-js":"fire-js",[it]:"fire-js-all"},at=new Map,ct=new Map;function ut(t,e){try{t.container.addComponent(e)}catch(n){D.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function lt(t){const e=t.name;if(ct.has(e))return D.debug(`There were multiple attempts to register component ${e}.`),!1;ct.set(e,t);for(const n of at.values())ut(n,t);return!0}function ht(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ut(t,e){return $(t,"POST","/v1/accounts:sendVerificationCode",R(t,e))}async function zt(t,e){return M(t,"POST","/v1/accounts:signInWithPhoneNumber",R(t,e))}async function Ht(t,e){const n=await M(t,"POST","/v1/accounts:signInWithPhoneNumber",R(t,e));if(n.temporaryProof)throw F(t,"account-exists-with-different-credential",n);return n}const qt={["USER_NOT_FOUND"]:"user-not-found"};async function Zt(t,e){const n=Object.assign(Object.assign({},e),{operation:"REAUTH"});return M(t,"POST","/v1/accounts:signInWithPhoneNumber",R(t,n),qt)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qn={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Zn=500,Wn=600,Kn="_blank",Gn="http://localhost";class Xn{constructor(t){this.window=t,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch(t){}}}function Qn(t,e,n,r=Zn,s=Wn){const o=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const u=Object.assign(Object.assign({},qn),{width:r.toString(),height:s.toString(),top:o,left:a}),l=(0,i.z$)().toLowerCase();n&&(c=ft(l)?Kn:n),ht(l)&&(e=e||Gn,u.scrollbars="yes");const h=Object.entries(u).reduce(((t,[e,n])=>`${t}${e}=${n},`),"");if(bt(l)&&"_self"!==c)return Yn(e||"",c),new Xn(null);const d=window.open(e||"",c,h);v(d,t,"popup-blocked");try{d.focus()}catch(f){}return new Xn(d)}function Yn(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $o=new ys(or.comparator);function Po(){return $o}const Mo=new ys(or.comparator);function Vo(...t){let e=Mo;for(const n of t)e=e.insert(n.key,n);return e}function Bo(t){let e=Mo;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function Fo(){return Uo()}function jo(){return Uo()}function Uo(){return new Ro((t=>t.toString()),((t,e)=>t.isEqual(e)))}const zo=new ys(or.comparator),Ho=new _s(or.comparator);function qo(...t){let e=Ho;for(const n of t)e=e.add(n);return e}const Zo=new _s(Yi);function Wo(){return Zo}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(t){this.ie=t}}function Ha(t){const e=Ta({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?Us(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class lc{constructor(t,e,n,i){this.targetId=t,this.fromCache=e,this.Si=n,this.Di=i}static Ci(t,e){let n=qo(),i=qo();for(const r of e.docChanges)switch(r.type){case 0:n=n.add(r.doc.key);break;case 1:i=i.add(r.doc.key)}return new lc(t,e.fromCache,n,i)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hc{constructor(){this.xi=!1}initialize(t,e){this.Ni=t,this.indexManager=e,this.xi=!0}getDocumentsMatchingQuery(t,e,n,i){return this.ki(t,e).next((r=>r||this.Oi(t,e,i,n))).next((n=>n||this.Mi(t,e)))}ki(t,e){if($s(e))return mr.resolve(null);let n=Fs(e);return this.indexManager.getIndexType(t,n).next((i=>0===i?null:(null!==e.limit&&1===i&&(e=Us(e,null,"F"),n=Fs(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next((i=>{const r=qo(...i);return this.Ni.getDocuments(t,r).next((i=>this.indexManager.getMinOffset(t,n).next((n=>{const s=this.Fi(e,i);return this.$i(e,s,r,n.readTime)?this.ki(t,Us(e,null,"F")):this.Bi(t,s,e,n)}))))})))))}Oi(t,e,n,i){return $s(e)||i.isEqual(er.min())?this.Mi(t,e):this.Ni.getDocuments(t,n).next((r=>{const s=this.Fi(e,r);return this.$i(e,s,n,i)?this.Mi(t,e):(Li()<=o["in"].DEBUG&&Ni("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),qs(e)),this.Bi(t,s,e,cr(i,-1)))}))}Fi(t,e){let n=new _s(Ks(t));return e.forEach(((e,i)=>{Zs(t,i)&&(n=n.add(i))})),n}$i(t,e,n,i){if(null===t.limit)return!1;if(n.size!==e.size)return!0;const r="F"===t.limitType?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Mi(t,e){return Li()<=o["in"].DEBUG&&Ni("QueryEngine","Using full collection scan to execute query:",qs(e)),this.Ni.getDocumentsMatchingQuery(t,e,lr.min())}Bi(t,e,n,i){return this.Ni.getDocumentsMatchingQuery(t,n,i).next((t=>(e.forEach((e=>{t=t.insert(e.key,e)})),t)))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,["next","error","complete"])}class Il extends ll{constructor(t,e,n,i){super(t,e,n,i),this.type="firestore",this._queue=new Tl,this._persistenceKey=(null==i?void 0:i.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||Ol(this),this._firestoreClient.terminate()}}function xl(t,e){const n="object"==typeof t?t:(0,r.Mq)(),i="string"==typeof t?t:e||"(default)",s=(0,r.qX)(n,"firestore").getImmediate({identifier:i});if(!s._initialized){const t=(0,a.P0)("firestore");t&&hl(s,...t)}return s}function Al(t){return t._firestoreClient||Ol(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function Ol(t){var e;const n=t._freezeSettings(),i=function(t,e,n,i){return new yr(t,e,n,i.host,i.ssl,i.experimentalForceLongPolling,i.experimentalAutoDetectLongPolling,i.useFetchStreams)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new Fi(Bi.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new sr(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sh(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new Fi(Bi.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class oh{}class ah extends oh{}function ch(t,e,...n){let i=[];e instanceof oh&&i.push(e),i=i.concat(n),function(t){const e=t.filter((t=>t instanceof lh)).length,n=t.filter((t=>t instanceof uh)).length;if(e>1||e>0&&n>0)throw new Fi(Bi.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,e=!0){!function(t){Ai=t}(r.Jn),(0,r.Xd)(new s.wA("firestore",((t,{instanceIdentifier:n,options:i})=>{const r=t.getProvider("app").getImmediate(),s=new Il(new qi(t.getProvider("auth-internal")),new Gi(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Fi(Bi.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new br(t.options.projectId,e)}(r,n),r);return i=Object.assign({useFetchStreams:e},i),s._setSettings(i),s}),"PUBLIC").setMultipleInstances(!0)),(0,r.KN)(Ii,"3.8.0",t),(0,r.KN)(Ii,"3.8.0","esm2017")}()}}]);
//# sourceMappingURL=chunk-vendors.9897d63d.js.map